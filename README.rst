...
* The Fastest, Easiest FPGA Blinker, Ever!:
  ...
  `[HTML1] <https://github.com/xesscorp/pygmyhdl/blob/master/examples/1_blinker/fastest_easiest_FPGA_blinker_ever.html>`_
...
* Hierarchy and Abstraction and Ursidae, Oh My!:
  ...
  `[HTML2] <https://github.com/xesscorp/pygmyhdl/blob/master/examples/2_hierarchy/hierarchy_and_abstraction_and_ursidae_oh_my.html>`_

* Pulse Width Modulators:
  `[Notebook3] <https://github.com/xesscorp/pygmyhdl/blob/master/examples/3_pwm/pwm.ipynb>`_ 
  `[HTML3] <https://github.com/xesscorp/pygmyhdl/blob/master/examples/3_pwm/pwm.html>`_

* Block (RAM) Party!:
  `[Notebook4] <https://github.com/xesscorp/pygmyhdl/blob/master/examples/4_blockram/block_ram_party.ipynb>`_ 
  `[HTML4] <https://github.com/xesscorp/pygmyhdl/blob/master/examples/4_blockram/block_ram_party.html>`_

* FSMs Without Monsters!:
  `[Notebook5] <https://github.com/xesscorp/pygmyhdl/blob/master/examples/5_fsm/fsm.ipynb>`_ 
  `[HTML5] <https://github.com/xesscorp/pygmyhdl/blob/master/examples/5_fsm/fsm.html>`_
